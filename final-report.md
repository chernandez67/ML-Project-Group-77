...
| Artist Name | Percent Accuracy |
| ----------- | ---------------- |
|Albrecht_Durer            | is 81.5  %|
|Alfred_Sisley             | is 77.2  %|
|Amedeo_Modigliani         | is 0.0  %|
|Andrei_Rublev             | is 51.6  %|
|Andy_Warhol               | is 0.0  %|
|Camille_Pissarro          | is 51.9  %|
|Caravaggio                | is 0.0  %|
|Claude_Monet              | is 62.1  %|
|Diego_Rivera              | is 0.0  %|
|Diego_Velazquez           | is 70.0  %|
|Edgar_Degas               | is 75.0  %|
|Edouard_Manet             | is 57.7  %|
|Edvard_Munch              | is 0.0  %|
|El_Greco                  | is 89.1  %|
|Eugene_Delacroix          | is 65.5  %|
|Francisco_Goya            | is 0.0  %|
|Frida_Kahlo               | is 0.0  %|
|Georges_Seurat            | is 0.0  %|
|Giotto_di_Bondone         | is 0.0  %|
|Gustav_Klimt              | is 0.0  %|
|Gustave_Courbet           | is 83.3  %|
|Henri_Matisse             | is 0.0  %|
|Henri_Rousseau            | is 0.0  %|
|Henri_de_Toulouse-Lautrec | is 0.0  %|
|Hieronymus_Bosch          | is 0.0  %|
|Jackson_Pollock           | is 0.0  %|
|Jan_van_Eyck              | is 0.0  %|
|Joan_Miro                 | is 0.0  %|
|Kazimir_Malevich          | is 73.1  %|
|Leonardo_da_Vinci         | is 0.0  %|
|Marc_Chagall              | is 0.0  %|
|Michelangelo              | is 0.0  %|
|Mikhail_Vrubel            | is 43.1  %|
|Pablo_Picasso             | is 83.3  %|
|Paul_Cezanne              | is 0.0  %|
|Paul_Gauguin              | is 82.4  %|
|Paul_Klee                 | is 0.0  %|
|Peter_Paul_Rubens         | is 0.0  %|
|Pierre-Auguste_Renoir     | is 0.0  %|
|Piet_Mondrian             | is 0.0  %|
|Pieter_Bruegel            | is 52.4  %|
|Raphael                   | is 0.0 %|
|Rembrandt                 | is 83.9  %|
|Rene_Magritte             | is 75.4  %|
|Salvador_Dali             | is 0.0  %|
|Sandro_Botticelli         | is 0.0  %|
|Titian                    | is 67.2  %|
|Vasiliy_Kandinskiy        | is 53.1  %|
|Vincent_van_Gogh          | is 70.8  %|
|William_Turner            | is 0.0  %|
